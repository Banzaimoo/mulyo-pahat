...
const Register = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // No validation or actual registration, just redirect
    navigate('/profile');
  };
    ...
    <div className="min-h-screen bg-sand flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-8 sm:p-10">
          ...
          <h2 className="text-2xl font-medium text-wood-darker mb-6">Create an Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ml-2 block text-sm text-wood-dark">
                I agree to the{' '}
                <Link to="/terms" className="font-medium text-wood-dark hover:text-wood-darker">
                  Terms of Service
                </Link>
                {' '}and{' '}
                <Link to="/privacy" className="font-medium text-wood-dark hover:text-wood-darker">
                  Privacy Policy
                </Link>
              </label>
            </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-wood-dark">
              ...
              <Link to="/login" className="font-medium text-wood-dark hover:text-wood-darker">
                Sign in
              </Link>
            </p>
          </div>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-wood-medium">Or sign up with</span>
              </div>
            </div>
